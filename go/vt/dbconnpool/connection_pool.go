...
func NewConnectionPool(name string, impl pools.Impl, capacity int, idleTimeout time.Duration, dnsResolutionFrequency time.Duration, minActive int) *ConnectionPool {
  cp := &ConnectionPool{
    impl:                impl,
    capacity:            capacity,
